                    ...
                    return (
                      <section key={skill.id} className="rounded-md border border-[#B4A5A5]/15 bg-[#151515]/80 p-4">
                        <div className="flex items-start gap-3">
                          <SkillIcon name={skill.name} iconUrl={skill.icon_url} className="h-12 w-12 border-[#B4A5A5]/60 bg-[#d8d0d0] text-[#151515] shadow-inner shadow-white/25 [&_img]:h-8 [&_img]:w-8" />
