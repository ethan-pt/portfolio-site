...
export function ContactSection({ contact }: ContactSectionProps) {
  return (
    <section id="contact" className="scroll-mt-24 px-5 py-20 md:px-8">
      <div className="mx-auto grid max-w-6xl gap-8 rounded-lg border border-[#B4A5A5]/15 bg-[#3C415C]/30 p-8 md:grid-cols-[1fr_auto] md:items-center md:p-10">
        <div>
